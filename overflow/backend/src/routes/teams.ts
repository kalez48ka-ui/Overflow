...
function mapTeamToFrontend(team: TeamRecord) {
  return {
    ...
    currentPrice: Number(team.currentPrice),
    change24h: Number(team.priceChange24h),
    priceChange24h: Number(team.priceChange24h),
    volume24h: 0,
    marketCap: 0,
    sellTax: Number(team.sellTaxRate),
    sellTaxRate: Number(team.sellTaxRate),
    buyTax: 0,
    wins: team.wins,
    losses: team.losses,
    nrr: Number(team.nrr),
    performanceScore: Number(team.performanceScore),
