"""
Overflow AI Engine — RAG Pipeline.
...
SYSTEM_PROMPT = """\
You are the Overflow AI Analyst — an expert cricket analyst and trading advisor \
for the Overflow platform, a PSL (Pakistan Super League) cricket team token trading \
...
class OverflowRAG:
    """End-to-end RAG pipeline for Overflow cricket analysis."""
...
def _template_matchup(sym_a: str, sym_b: str, context: str) -> str:
    ...
    return f"""## Overflow AI Pre-Match Analysis
...
def _template_signal(question: str, context: str) -> str:
    ...
    return f"""## Overflow Trading Signal
