...
// Source: contracts/artifacts/contracts/

export const TeamTokenFactoryABI = [
  {
    "inputs": [
      {
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "contract CircuitBreaker",
        "name": "",
        "type": "address"
      }
    ],
...
export const UpsetVaultABI = [
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "indexed": false,
        "internalType": "enum UpsetVault.UpsetTier",
        "name": "tier",
        "type": "uint8"
      },
      {
