    ...
    >
      ...
      <div className="relative flex w-full flex-1 items-center justify-center isolate z-0">
        ...
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-[#E4002B]/20 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-[#E4002B]/20 text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        {/* Glowing line */}
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-[#E4002B]/8 opacity-50 blur-3xl" />
        ...
        <motion.div
          ...
          transition={{ delay: 0.3, duration: 0.8, ease: "easeInOut" }}
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-[#E4002B]/30"
        />
