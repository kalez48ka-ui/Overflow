"""
CricTrade AI Engine — Pre-Match Report Generator.

Takes two team symbols and produces a structured, compelling pre-match analysis
report suitable for display on the CricTrade frontend.
"""
...
class ReportGenerator:
    """Generate structured pre-match analysis reports for CricTrade."""
    ...
    def _assemble_report(
        ...
        *,
        ...
        report = f"""## CricTrade AI Pre-Match Analysis
...
---
*Generated by CricTrade AI Engine | {datetime.now(timezone.utc).strftime("%Y-%m-%d %H:%M UTC")}*
"""
        return report
