"""
CricTrade AI Engine — Flask API Server.
...
logger = logging.getLogger("crictrade.server")
...
def _init() -> None:
    ...
    logger.info("Initialising CricTrade AI Engine...")
    ...
    # 3. RAG pipeline
    _rag = CricTradeRAG(vector_store=_vector_store)
    ...
    _initialised = True
    logger.info("CricTrade AI Engine initialisation complete.")
...
if __name__ == "__main__":
    logger.info("Starting CricTrade AI Engine on port %d ...", FLASK_PORT)
    app.run(
        host="0.0.0.0",
        port=FLASK_PORT,
        debug=FLASK_DEBUG,
